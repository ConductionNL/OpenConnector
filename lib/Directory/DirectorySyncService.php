...
class DirectorySyncService {
	...
	private function guard(
		...
		return $this->guarded(
			...
			message: $this->l10n->t(
				'This run would remove %1$s of %2$s memberships, which is over the limit of %3$s set for this connection. Nothing was removed. Confirm the removals to continue.',
